...
type ClientFormDefaults = Pick<NewClient, 'id' | 'emailVerified'>;
...
type ClientFormGroupContent = {
  ...
  emailVerified: FormControl<IClient['emailVerified']>;
  signUpDate: FormControl<IClient['signUpDate']>;
};
...
export class ClientFormService {
  createClientFormGroup(client: ClientFormGroupInput = { id: null }): ClientFormGroup {
    ...
    return new FormGroup<ClientFormGroupContent>({
      ...
      emailVerified: new FormControl(clientRawValue.emailVerified),
      signUpDate: new FormControl(clientRawValue.signUpDate),
    });
  }
