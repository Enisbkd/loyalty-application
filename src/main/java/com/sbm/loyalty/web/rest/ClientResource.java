...
/**
 * REST controller for managing {@link com.sbm.loyalty.domain.Client}.
 */
@RestController
...
public class ClientResource {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<Client> updateClient(@PathVariable(value = "id", required = false) final Integer id, @RequestBody Client client)
