...
import static com.sbm.loyalty.domain.ClientAsserts.*;
...
class ClientResourceIT {
    ...
    private static final String DEFAULT_SIGN_UP_DATE = "AAAAAAAAAA";
    private static final String UPDATED_SIGN_UP_DATE = "BBBBBBBBBB";
    ...
    public static Client createEntity() {
        return new Client()
            ...
            .signUpDate(DEFAULT_SIGN_UP_DATE);
    }
    ...
    public static Client createUpdatedEntity() {
        return new Client()
            ...
            .signUpDate(UPDATED_SIGN_UP_DATE);
    }
    ...
    void getAllClients() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.[*].signUpDate").value(hasItem(DEFAULT_SIGN_UP_DATE)));
    }
    ...
    void getClient() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.signUpDate").value(DEFAULT_SIGN_UP_DATE));
    }
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.email(UPDATED_EMAIL).dateOfBirth(UPDATED_DATE_OF_BIRTH).signUpDate(UPDATED_SIGN_UP_DATE);
